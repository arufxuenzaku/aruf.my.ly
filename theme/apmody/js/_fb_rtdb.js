...
function _CvdAG(){dD=qSell(".pvw");for(var e=firebase.database(),a=0;a<dD.length;a++){var t=dD[a],s=t.getAttribute("data-id");(s=e.ref("BlogID_"+blogId+"/"+s)).once("value",function(e,a){return function(a){var t=a.exists()&&null!=a.val()._view?a.val()._view:0,s=a.exists()&&null!=a.val()._dl?a.val()._dl:0;e.classList.contains("s")||(s>0&&e.insertAdjacentHTML("afterbegin",'<span data-text="'+xAR.abv(s)+'">'+ARtb.firebase.counter.iconDl+'</span>'),t>0&&e.insertAdjacentHTML("afterbegin",'<span data-text="'+xAR.abv(t)+'">'+ARtb.firebase.counter.iconView+'</span>'),addCt(e,"s"))}}(t))}}
}
/*]]>*/
